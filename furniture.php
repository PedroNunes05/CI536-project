            ...
            if($mysqli->connect_errno){
                ...
                exit();
                    ...
                    $sql = 'SELECT price, descript, productName, photo from tProduct '
                         ...
                         . 'where tCategory.categoryName = "Furniture" ';
...
<p class = "nav2"> 
 <a href = "index.html"> Home </a> &#8680; Furniture
</p>
  ...
  <span class="closebtn">&times;</span>
	  ...
	  <form action="/action_page.php" id="filter-form">
		  ...
		  <div class="filter">
			  ...
			  <div class="input">
			  <input type="radio" id="chairs" name="type" value="Chairs">
			  <label for="chairs">Chairs</label><br>  
			  </div>
			  
			  <div class="input">
			  <input type="radio" id="tables" name="type" value="Tables">
			  <label for="tables">Tables</label><br>  
			  </div>
			  
			  <div class="input">
			  <input type="radio" id="accessories" name="type" value="Accessories">
