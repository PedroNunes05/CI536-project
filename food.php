            ...
            if($mysqli->connect_errno){
                ...
                exit();
                    ...
                    $sql = 'SELECT price, descript, productName, photo from tProduct '
                         ...
                         . 'where tCategory.categoryName = "Food" ';
  ...
  <span class="closebtn">&times;</span>
	  ...
	  <form action="/action_page.php" id="filter-form">
		  ...
		  <div class="filter">
			  ...
			  <div class="input">
			  <input type="radio" id="vegetables" name="type" value="Vegetables">
			  ...
			  <div class="input">
			  <input type="radio" id="confectionery" name="type" value="Confectionery">
			  <label for="confectionery">Confectionery</label><br>
			  </div>
	  ...
	  <br>  
		  ...
		  <input type="range" id="price-range" min="3" max="25" value="14">
		  <div id= "min-max">
		  <div id="min"> £3 </div>
		  <div id="max"> £25 </div>
		  </div>
