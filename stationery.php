            ...
            if($mysqli->connect_errno){
                ...
                exit();
                    ...
                    $sql = 'SELECT price, descript, productName, photo from tProduct '
                         ...
                         . 'where tCategory.categoryName = "Stationery" ';
...
<p class = "nav2"> 
 <a href = "index.html"> Home </a> &#8680; Stationery
</p>
  ...
  <span class="closebtn">&times;</span>
	  ...
	  <form action="/action_page.php" id="filter-form">
		  ...
		  <div class="filter">
			  ...
			  <div class="input">
			  <input type="radio" id="student-essentials" name="type" value="Student essentials">
			  <label for="student-essentials">Student essentials</label><br>  
			  </div>
			  
			  <div class="input">
			  <input type="radio" id="calendars-planners" name="type" value="Calendars/Planners">
			  <label for="calendars-planners">Calendars/Planners</label><br>  
			  </div>
			  
			  <div class="input">
			  <input type="radio" id="filing-folders" name="type" value="Filing/Folders">
			  <label for="filing-folders">Filing/Folders</label><br>
			  </div>
			  
			  <div class="input">
			  <input type="radio" id="notebooks-papers" name="type" value="Notebooks/Papers">
			  <label for="notebooks-papers">Notebooks/Papers</label><br><br>
			  </div>
	  ...
	  <br>  
		  ...
		  <input type="range" id="price-range" min="5" max="30" value="17">
		  <div id= "min-max">
		  <div id="min"> £5 </div>
		  <div id="max"> £30 </div>
		  </div>
